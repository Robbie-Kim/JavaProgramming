...
// 인터페이스는 멤버변수는 static final 인 변수만 가질 수 있고,
// 메소드는 추상메소드만 가질 수 있다.
...
public interface Board {
	...
	// 3. 모든 메소드가 추상메소드이기 때문에 중괄호 블록({}) 을 사용하면 에러가 발생한다.
